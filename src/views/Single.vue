                ...
                <div class="left-ads-display col-lg-12">
                    <div class="row">
                        <div class="desc1-left col-md-6">
                            <img src="bundles/images/images.jpeg" class="img-fluid" alt="">
                        </div>
                        <div class="desc1-right col-md-6 pl-lg-4">
                            ...
                            <ul>
                                ...
                                <li class="li-movie"><span><b>Страна:</b> США, Китай</span></li>
                                <li class="li-movie"><span><b>Слоган:</b> «Welcome to the Day after Judgment Day»</span></li>
                                <li class="li-movie"><span><b>Режиссер:</b> Тим Миллер</span></li>
                                ...
                                <li class="li-movie"><span><b>Жанр:</b> фантастика, боевик, приключения</span></li>
                                <li class="li-movie"><span><b>Премьера в мире:</b> 23 октября 2019</span> </li>
                                <li class="li-movie"><span><b>Бюджет:</b> $185 000 000</span></li>
                                <li class="li-movie"><span><b>Сборы в США:</b> $61 150 256</span></li>
                                <li class="li-movie"><span><b>Сборы в мире:</b> $250 369 693</span></li>
                                <li class="li-movie">
                                    <a href="#"><b>Рейтинг:</b>
                    ...
                    <div class="row">
                        <div class="single-form-left">
                            <div class="contact-single">
                                <h3 class="editContent"><span class="sub-tittle editContent">02</span>Оставить отзыв</h3>
                                <form action="#" method="get" class="mt-4">
                                    ...
                                    <button type="submit" clss="mt-3 btn btn-success btn-block py-3">Отправить</button>
                                </form>
                            </div>
                        </div>
                        <div class="media py-5">
                            ...
                            <div class="media-body mt-4">
                                ...
                                <div class="media mt-5 editContent">
                                    <a class="pr-3" href="#">
                                        <img src="bundles/images/te1.jpg" class="img-fluid" alt="image" style="outline: none; cursor: inherit;">
                                    </a>
